...
C("createRooms", ["require", "exports", "module"], function (c, k, module) {
...
C("localVideo", ["require", "exports", "module"], function (c, k, module) {
  ...
  function localVideo(opts, callback) {
    var
      ...
      localVideo = {
        $video: $video,
        view: new Mapmaker.VideoView($video[0], $('body'), 'me', true, { DOUBLE_CLICK_TOLERANCE: 200 }),     
      };
    return localVideo;
  }
...
C("app", "require exports module smallSurface auth createRooms localVideo ioconnection 0/4 0/c 0/2 0/9 0/e 0/f 0/1 0/5 0/7 0/6 0/g 1/i 1/j 1/s 1/r 1/p 1/l 1/q 1/n 1/o 1/m 3/14 3/15 3/16 3/19 3/1a 6/1i 6/1k 6/1j 2/z 4/1d 4/1c 6/1l 6/1l 6/1l 6/1l".split(" "), function(c, something, module) {
  ...
  var begin = function(firebase, socketUrl) {
    ...
    function displayRoom(index, target) {
      ...
      $target.append(room.Realtime.chat.$container);
      ...
      //if (app.readyToCall) {
        room.join(function (err, roomDesc) {
          ...
          room.Realtime.videoAdded(addVideo);
          
          for (peer in room.Realtime.videos) {
            console.log(1, room.Realtime.videos[peer]);
            addVideo(room.Realtime.videos[peer]);
          }
        });
      /*} else {
    ...
    var hc = t(4, '<img src="content/icons/paraflow.png" alt="PF" />', "paraflow"),
